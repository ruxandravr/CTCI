...
TEST(HashtableTest, DefaultHashFuncInsertAndGet) {
    Hashtable<int, std::string> H1;
    H1.insert(1, "Ana");
    H1.insert(2, "Radu");
    H1.insert(11, "Maria");
...
TEST(HashtableTest, GivenHashFuncInsertAndGet) {
    Hashtable<std::string, int> H2(SIZE, [](std::string x) {
        int sum = 0;
